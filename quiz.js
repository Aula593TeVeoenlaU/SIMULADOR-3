...
const questions = [
    ...
    { id: 6, block: 'RAZONAMIENTO MATEMÁTICO', text: 'Si, 3 < |x| < 5 y 4 < |y| < 6 . ¿Cuál de las siguientes opciones debe ser verdadera?', options: ['a) y < x', 'b) x < y', 'c) |xy| > 12', 'd) |x+y| > 7'], answer: 'd' },
    ...
    { id: 11, block: 'APTITUD ESPACIAL', text: 'Considere las siguientes figuras.', image: 'imagenes/ejercicio11_ae.png', imageStyle: 'max-width: 450px;', image2: 'imagenes/ejercicio112_ae.png', image2Style: 'max-width: 250px;', options: ['a) Opción 1', 'b) Opción 2', 'c) Opción 3', 'd) Opción 4'], answer: 'a' },
    { id: 12, block: 'APTITUD ESPACIAL', text: '¿Cuál de las siguientes casillas debe reemplazar el signo de interrogación para completar el patrón?', image: 'imagenes/ejercicio12_ae.png', imageStyle: 'max-width: 450px;', options: ['a) Opción 1', 'b) Opción 2', 'c) Opción 3', 'd) Opción 4'], answer: 'd' },
    { id: 13, block: 'APTITUD ESPACIAL', text: '¿Cuál es la opción que sustituye a los signos de interrogación?', image: 'imagenes/ejercicio13_ae.png', imageStyle: 'max-width: 250px;', options: ['a) 5 – 4', 'b) 0 – 4', 'c) 0 – 1', 'd) 2 – 1'], answer: 'b' },
    { id: 14, block: 'APTITUD VERBAL', text: 'Considere el siguiente texto: "Ese texto, sin duda, por sus contenidos, por la manera en que está redactado, por su gran aporte histórico y demás características, promete tener gran envergadura para todos aquellos lectores que logren identificar toda su riqueza". Según el texto, ¿cuál palabra es equivalente a “envergadura”?', options: ['a) Trascendencia', 'b) Calidad', 'c) Sentido', 'd) Significado'], answer: 'a' },
    { id: 15, block: 'APTITUD VERBAL', text: '15. Seleccione la alternativa que exprese el significado más opuesto al de la palabra escrita en letras mayúsculas: CÁNDIDO', options: ['a) Incrédulo', 'b) Desinhibido', 'c) Astuto', 'd) Experimentado'], answer: 'c' },
    { id: 16, block: 'APTITUD VERBAL', text: 'Considere el siguiente texto: "El chiste es un dicho breve, agudo y gracioso que surge espontáneamente del pueblo; algunos investigadores y autores los recopilan para su publicación". Según el texto, ¿cuál palabra sintetiza los términos subrayados?', options: ['a) Sagaz', 'b) Burlesco', 'c) Ingenioso', 'd) Perspicaz'], answer: 'c' },
    { id: 17, block: 'APTITUD VERBAL', text: 'La diferencia entre mito y leyenda es imprecisa, ya que sus orígenes son __________. En su lenguaje desempeñan un papel de particular relevancia la __________ y la alegoría; ya que describen figuras míticas, que generalmente son __________. Según el texto, ¿cuáles palabras completan el párrafo anterior con sentido lógico?', options: ['a) idénticos – poesía – insólitas', 'b) semejantes – metáfora – simbólicas', 'c) exactos – ambigüedad – metafísicas', 'd) relacionados – historia – imaginarias.'], answer: 'b' },
    { id: 18, block: 'APTITUD VERBAL', text: 'En el siguiente ítem escoja la opción, aquella que tenga un significado diferente (que no comparte relación semántica) con la palabra escrita con letras mayúsculas y las demás del grupo. SIGNO', options: ['a) Punto', 'b) Coma', 'c) Guión', 'd) Tilde'], answer: 'd' },
    { id: 19, block: 'APTITUD VERBAL', text: 'En el siguiente ejercicio, seleccione la alternativa que establezca la misma relación que hay entre las dos palabras escritas con mayúsculas. INVITACIÓN es a DEFERENCIA como …', options: ['a) Parecer es a libertad', 'b) Préstamo es a seguridad', 'c) Obsequio es a generosidad', 'd) Donación es a comercio'], answer: 'c' },
    { id: 20, block: 'APTITUD VERBAL', text: '“A continuación, usted encontrará un fragmento de lectura, lea el texto y responda a la pregunta planteada, de acuerdo con lo expresado en dicho texto: La protección de la libertad a la que se refiere el código penal no es la defensa de la libertad política, sino de la libertad social, de la relación del ciudadano con los demás miembros de la sociedad. El mero hecho de vivir en sociedad obliga al ciudadano a renunciar a gran parte de su libertad, a gran parte de su voluntad, lo que relativiza extraordinariamente este concepto”. ¿Qué protege el código penal?', options: ['a) La voluntad restringida', 'b) La libertad política', 'c) La libertad social', 'd) La libertad limitada'], answer: 'c' }
];
